...
#order_number_gen = make_order_number_generator (10)
#next_order_number = order_number_gen.next
...
#o1.add (date.today()+timedelta(days=14), 250*100, generate_kid (123,1))
o1.add (date.today()+timedelta(days=14), 250*100, generate_kid (123,1),
...
#o1.add (date.today()+timedelta(days=20), 100*100, generate_kid (123,0))

o2 = PaymentClaim (args.account, next_order_number())
o2.add (date.today()+timedelta(days=30), 500*100, generate_kid (321))

# Q: Must use same order number as the payment-claim we are canceling?
#c1 = CancellationRequest (args.account, next_order_number())
#c1.add (date.today()+timedelta(days=14), 250*100, generate_kid (123))
